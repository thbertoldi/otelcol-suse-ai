...
import (
	...
	drainprocessor "github.com/open-telemetry/opentelemetry-collector-contrib/processor/drainprocessor"
...
func components() (otelcol.Factories, error) {
	...
	factories.ExtensionModules = makeModulesMap(factories.Extensions, map[component.Type]string{
		...
		cgroupruntimeextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/cgroupruntimeextension v0.160.0",
		...
		k8sleaderelector.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/k8sleaderelector v0.160.0",
	})
	...
	factories.ReceiverModules = makeModulesMap(factories.Receivers, map[component.Type]string{
		...
		elasticsearchreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/elasticsearchreceiver v0.160.0",
	})
	...
	factories.ProcessorModules = makeModulesMap(factories.Processors, map[component.Type]string{
		...
		drainprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/drainprocessor v0.160.0",
